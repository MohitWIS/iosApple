...
function onFSSuccess(fs) {
    try {
        localFileSystem = fs;
        localFileSystem.root.getDirectory("eteachernew.pro", {
                                          create: true
...
                                        CurrentBookingLi += '<li data-theme="h" class="ui-bar-h clientheader ui-li ui-li-divider ui-first-child" style="padding: 8px 0px 8px 16px;background: #41424C !important;min-height:3em;"><div class="bookingdatehead" style="color: white;white-space: normal !important;font-size:15px;font-weight:bold;margin-top: 11px;">'+CurrentBooking[i].moduleTitle+'</div></li>'
                                        ...
                                        CurrentBookingLi += '<li style="padding-top:8px; padding-bottom:8px;padding-right:0px;" class="scheduleitem  ui-li-static ui-body-h" data-theme="h"><div class="scheduleitemmain"><div id=head'+CurrentBooking[i].AssessmentBookingId+' class="scheduleitemhead tabWidth" style="padding-top:12px !important;font-size:15px !important;">'+CurrentBooking[i].ScheduledDate+', '+CurrentBooking[i].ScheduledTime+'</div><div class=Upnocancel style="float:right !important;    font-size: 15px;"><a style="color: white;font-size: 15px;" class=nocancel ui-btn ui-btn-h" data-theme="h" >'+resources.cancelbtntxt+'</a></div><div class="Upnocancel" style="float:right !important;font-size: 0.8em;background-color:#374c68 !important;"><a style="color: white;font-size: 0.8em;" id="'+CurrentBooking[i].AssessmentBookingId+'" class="viewVenue" ui-btn="" ui-btn-h"="" data-theme="h">'+resources.detailsbtntxt+'</a></div></div></li>';
                                    }else{
                                        CurrentBookingLi += '<li data-theme="h" class="ui-bar-h clientheader ui-li ui-li-divider ui-first-child" style="padding: 8px 0px 8px 16px;background: #41424C !important;min-height:3em;"><div class="bookingdatehead" style="color: white;white-space: normal !important;font-size:15px;font-weight:bold;margin-top: 11px;">'+CurrentBooking[i].moduleTitle+'</div></li>'
...
                                    CurrentEclassLi += '<li data-theme="h" class="ui-bar-h clientheader ui-li ui-li-divider ui-first-child" style="padding: 8px 0px 8px 16px;background: #41424C !important;min-height:2.5em !important;"><div class="bookingdatehead" style="color: white;white-space: normal !important;font-size:'+text_size+';font-weight:bold;margin-top: 11px;">'+CurrentEclasses[i].ClassName+'</div></li>'
                                    ...
                                    CurrentEclassLi += '<li class="scheduleitem  ui-li-static ui-body-h" data-theme="h" style="height:2em !important;padding-right:0px;padding-bottom:8px;padding-top:8px !important;"><div class="scheduleitemmain"><div id=head'+CurrentEclasses[i].eClassBookingId+' class="scheduleitemhead" style="width:54%;font-size:15px !important;padding-top: 1.9% !important">'+CurrentEclasses[i].ScheduledDate+', '+CurrentEclasses[i].ScheduledTime+'</div><div class="'+CancelBookBtn+'" style="float:right !important;    font-size: 15px;height:41px;margin-top:-8px;"><a style="font-size:15px !important;padding-top:11px;" class="'+CancelclassForAvai+' ui-btn ui-btn-h" data-theme="h" href="'+CurrentEclasses[i].URL+'" id="'+CurrentEclasses[i].eClassBookingId+'">'+btnText+'</a></div><img id="img-'+CurrentEclasses[i].eClassBookingId+'" alt="'+CurrentEclasses[i].ZoomMeetingPassword+'" style="display:none;height: 21px;float: right;padding-top: 2%;" class="'+showPassowrd+'" src="css/client/images/passwordHide.png" ><div id=hide-img-'+CurrentEclasses[i].eClassBookingId+' style="float:right;font-size: 0.8em;padding-top: 3%;letter-spacing: 3px;display:none;" class='+showPassowrdStar+'>******</div></div></li>';
