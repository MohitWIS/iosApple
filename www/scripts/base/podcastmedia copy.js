    ...
    try {
        ...
        if (this.audios != undefined && this.audios.length > 0) {
            ...
            if (allAudiosDownloaded === true) {
                audioStr += "<span class='onall' id='ondeleteaudioall-" + itemId + "'>Delete</span><li class='msdeleteall catli podcastli ui-list-divider downloadallli swipedeleteall' data-theme='h'><div class='podcastlidiv'>";
                audioStr += "<div class='podcastitemdiv podcastitemdivdownload' id='podcastitemdivmain-"  + itemId + "'>";
            }
            else
            {
                audioStr += "<span class='onall' id='ondeleteaudioall-" + itemId + "'>Delete</span><li class='msdeleteall catli podcastli ui-list-divider downloadallli' data-theme='h'><div class='podcastlidiv'>";
                audioStr += "<div class='podcastitemdiv podcastitemdivdownload' id='podcastitemdivmain-"  + itemId + "'>";
...
getAudioItemLi: function(itemNo, audioMixItemDownloaded, audioMixIsDownloading) {
    try {
        ...
        if (this.isdownloaded === true) {
            var itemsStr = "<span class='on' id='ondeleteaudio-" + itemId + "'>"+resources.deletesingletrack+"</span><li class='catli podcastli swipeallow' id='mdeleteaudio-" + itemId + "' data-theme='h'></div><div id='podcastlidiv-" + itemId + "' class='podcastlidiv'>";
        }
        else
        {
